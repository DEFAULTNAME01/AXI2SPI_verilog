...
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_araddr
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_arprot
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_arready
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_arvalid
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_awaddr
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_awprot
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_awready
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_awvalid
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_bready
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_bresp
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_bvalid
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_rdata
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_rready
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_rresp
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_rvalid
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_wdata
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_wready
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_wstrb
add wave -noupdate -expand -group BridgeTopIO /simulation_top/axi_spi_DUT/AXI_wvalid
